...
This is a sample server Petstore server.  You can find out more about     OpenApi at [http://swagger.io](http://swagger.io) or on [irc.freenode.net, #swagger](http://swagger.io/irc/).      For this sample, you can use the api key `special-key` to test the authorization     filters.
...
<h3 id="update-an-existing-pet-responseschema">Response Schema</h3>
...
<h3 id="add-a-new-pet-to-the-store-responseschema">Response Schema</h3>
...
<h3 id="updates-a-pet-in-the-store-with-form-data-responseschema">Response Schema</h3>
...
<h3 id="deletes-a-pet-responseschema">Response Schema</h3>
...
<Order>
  ...
  <petId>0</petId>
  <quantity>0</quantity>
  <shipDate>2020-05-10T19:47:32Z</shipDate>
...
<h3 id="place-an-order-for-a-pet-responseschema">Response Schema</h3>
...
<h3 id="find-purchase-order-by-id-responseschema">Response Schema</h3>
...
<h3 id="delete-purchase-order-by-id-responseschema">Response Schema</h3>
...
<h3 id="creates-list-of-users-with-given-input-array-responseschema">Response Schema</h3>
...
<h3 id="logs-out-current-logged-in-user-session-responseschema">Response Schema</h3>
...
<h3 id="get-user-by-user-name-responseschema">Response Schema</h3>
...
<h3 id="updated-user-responseschema">Response Schema</h3>
